...
use util::merkle_tree::MerkleRoot;
...
impl<T: MyField> FriVerifier<T> {
    pub fn new(
        ...
        coset: &Vec<Coset<T>>,
        vector_interpolation_coset: &Coset<T>,
        polynomial_commitment: MerkleRoot,
        oracle: &RandomOracle<T>,
        step: usize,
    ) -> Self {
        FriVerifier {
    ...
    pub fn set_h_root(&mut self, h_root: MerkleRoot) {
    ...
    pub fn receive_folding_root(&mut self, leave_number: usize, folding_root: MerkleRoot) {
